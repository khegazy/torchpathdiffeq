...
class TestUniformEvaluateAdaptiveY:
    ...
    def test_single_step_split_shapes(self):
        ...
        y_add, t_add = solver._evaluate_adaptive_y(constant_ode_fxn, torch.tensor([0]), y, t)
    ...
    def test_midpoint_exact(self):
        ...
        _, t_add = solver._evaluate_adaptive_y(constant_ode_fxn, torch.tensor([0]), y, t)
    ...
    def test_ode_fxn_values(self):
        ...
        y_add, _ = solver._evaluate_adaptive_y(constant_ode_fxn, torch.tensor([0]), y, t)
...
class TestUniformMergeExcessT:
    ...
    def test_merge_first_pair(self):
        ...
        assert torch.allclose(t_p[0, -1, 0], torch.tensor(2.0 / 3, dtype=torch.float64), atol=1e-10)
    ...
    def test_empty_remove_idxs(self):
        ...
        t_p, ss_p, se_p = solver._merge_excess_t(t, ss, se, torch.tensor([], dtype=torch.long))
